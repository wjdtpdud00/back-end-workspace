...
CREATE TABLE product(
    ...
    prod_desc TEXT, -- 상품설명 -- 길어질것같으면 TEXT 
...
CREATE TABLE review(
	revi_code INT AUTO_INCREMENT PRIMARY KEY, -- 리뷰코드
    id VARCHAR(50), -- 아이디
    prod_code INT, -- 상품 코드
...
CREATE TABLE purchase(
    ...
    pur_status VARCHAR(10) CHECK (pur_status IN ('구매대기중','구매중','구매완료', '배송대기중','배송중','배송완료'))
    DEFAULT '구매대기중'-- 구매 상태
);-- 구매 내역
CREATE TABLE delivery(
	deli_code INT AUTO_INCREMENT PRIMARY KEY,-- 배송코드
    pur_code INT,-- 구매 코드

...
public class F_Triple {
	 ...
	 * 실습 문제 1
	 * 
	 * 사용자한테 두 개의 정수값을 입력받아서 두 정수의 곱셈 결과 100보다 큰 경우
	...
	public void pactice3() {
		...
		// String -> int : Integer.parseInt (점 쉬프트 커서올려보기)
		...
		char op = sc.nextLine().charAt(0); // charAt없는데 찾으려해서 오류뜸!
		
		
		//String result = op == '+' ? "3 + 4 = 7" : op == '-' ? "3 - 4 = -1 ": "잘못 입력했습니다.";
		//String result = op == '+' ? num1 + "+" + num2 + "-" + (num1 + num2) : "잘못 입력했습니다."; - true일때만
		
		//String result = op == '+' ? num1 + "+" + num2 + "=" + (num1 + num2) 
		//						  :op == '-' ? num1 + "-" + num2 + "=" + (num1 + num2)
		//						  : "잘못 입력했습니다."; -- true,false 일때
...
//		
//		// 또 다른 방법
//		System.out.println(%d %c %d = %d, num1, op, num2,
//									op=='+' ? (num1+num2) : (num1-num2));

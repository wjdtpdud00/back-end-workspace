 ...
 * - 인터넷에 존재하는 서버들의 자원에 접근할 수 있는 구조
 * 
...
//		u.method1();
	...
	//https://www.youtube.com/results?search_query=여행 쪼개기
	public void method1() {
		try {
	 ...
	 * 4계층 - 애플리케이션 계층	7계층 : 응용 계층 - 프로토콜(HTTP, FTP, SMTP(이메일관련), POP3...)
	 * 				        6계층 : 표현 계층 - 파일 인코딩(JPG, MPEDG)
	 * 						5계층 : 세션 계층 - API, Socket
	 * 3계층 - 전송 계층	    4계층 : 전송 계층 - TCP/UDP, PORT 번호 
	 * 2계층 - 인터넷 계층		3계층 : 네트워크 계층 - IP, 패킷(Packet 데이터 포장 기능)

...
/*
    ...
    * 자료형
    1. 문자
		- CHAR / **VARCHAR** : 고정 및 가변 길이 문자, 크기지정 필수
	...
	5. 이진 자료형
		- BLOB : 이진 데이터를 저장하는데 사용. 이미지나 동영상 같은 이진 파일
...
INSERT INTO mem_unique VALUES(3, 'user03', 'pass03', '정동준', 'ㄴ', null, null, null, null);
...
INSERT INTO mem_check
VALUES(2, 'user02', 'pass02', '손민정', '0', null, null, null);
-- > check 제약조건에 위배되었기 때문에 오류 발생!

INSERT INTO mem_check
VALUES(2, 'user02', 'pass02', '손민정', '여', null, null, null);
-- > check 제약조건 뿐만 아니라 null도 처리해야 된다는것!
...
-- > 기본키를 mem_no + meme_id 복합키로 설정했을 때는 가능!
...
INSERT INTO member
VALUES(2, 'user02', 'pass02', '조세미', '여', null, null, null);

INSERT INTO member
VALUES(3, 'user03', 'pass03', '정회영', '남', null, null, null);
